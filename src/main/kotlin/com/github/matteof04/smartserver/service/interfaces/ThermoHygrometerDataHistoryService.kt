...
interface ThermoHygrometerDataHistoryService {
    suspend fun dataHistory(id: UUID): ThermoHygrometerDataHistory?
    suspend fun new(newThermoHygrometerDataHistory: NewThermoHygrometerDataHistory): ThermoHygrometerDataHistory?
    suspend fun all(deviceId: UUID): List<ThermoHygrometerDataHistory>
}